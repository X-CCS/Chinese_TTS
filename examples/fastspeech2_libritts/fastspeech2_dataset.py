...
class CharactorDurationF0EnergyMelDataset(AbstractDataset):
    ...
    def __init__(
        ...
        print("charactor_files len is :", len(charactor_files))
        print("mel_files len is :", len(mel_files))
        print("duration_files len is :", len(duration_files))
        print("f0_files len is :", len(f0_files))
        print("energy_files len is :", len(energy_files))
