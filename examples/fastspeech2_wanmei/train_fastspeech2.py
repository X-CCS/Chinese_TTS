...
from examples.fastspeech2_wanmei.fastspeech2_dataset import CharactorDurationF0EnergyMelDataset
...
def main():
    ...
    """
    aa = train_dataset = CharactorDurationF0EnergyMelDataset( 
        root_dir=args.train_dir, 
        charactor_query=charactor_query, 
        mel_query=mel_query, 
        duration_query=duration_query, 
    ...
    """
    # check data is error or not
    for data in tqdm(train_dataset):
        # debug 1 step forward
        try:
            #print("data is :", data)
            outputs = fastspeech(**data)
        except:
            print("utt_id is :", data["utt_ids"])
